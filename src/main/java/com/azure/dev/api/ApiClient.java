...
import com.azure.dev.api.auth.Authentication;
import com.azure.dev.api.auth.HttpBasicAuth;
import com.azure.dev.api.auth.HttpBearerAuth;
import com.azure.dev.api.auth.ApiKeyAuth;
import com.azure.dev.api.auth.OAuth;
import com.azure.dev.api.auth.RetryingOAuth;
import com.azure.dev.api.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://app.vssps.visualstudio.com/oauth2/token?client_assertion_type&#x3D;urn:ietf:params:oauth:client-assertion-type:jwt-bearer&amp;grant_type&#x3D;urn:ietf:params:oauth:grant-type:jwt-bearer";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/6.1-preview/java");
